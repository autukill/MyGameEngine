...
7. 已完成双 View resize、不同 RenderScale 效果租约和逐 View release 的 GPU 像素回归。多 Camera/View 当前里程碑闭环；Gameplay Authoring 已继续落地 Cooldown、Health/Damage 与强类型 Instance Ref，Gameplay Signal 暂只验证需求，不预建全局总线。
