...
7. 已完成双 View resize、不同 RenderScale 效果租约和逐 View release 的 GPU 像素回归。多 Camera/View 当前里程碑闭环；Gameplay Authoring 已继续落地 owner-local Cooldown 与 Health/Damage，下一项评估对象间 Gameplay Signal 的最小稳定边界。
